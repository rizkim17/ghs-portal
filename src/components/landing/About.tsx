export default function About() {
  return (
    <section id="tentang" className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-12 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-xs sm:text-sm font-bold text-primary tracking-wider uppercase mb-2">Tentang LPK GHS</h2>
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">Kenapa Memilih LPK GHS?</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-3xl bg-gray-100 overflow-hidden shadow-soft flex items-center justify-center text-gray-400 text-sm sm:text-base">
              [ Foto / Dokumentasi Kelas ]
            </div>
            
            {/* Stats Badge */}
            <div className="absolute -bottom-5 sm:-bottom-8 right-3 sm:-right-4 lg:-right-8 bg-primary text-white p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-card">
              <div className="text-2xl sm:text-4xl font-bold mb-1">5+</div>
              <div className="text-primary-100 text-xs sm:text-sm font-medium">Tahun Pengalaman</div>
            </div>
          </div>
...
function FeatureItem({ title, description }: { title: string, description: string }) {
  return (
    <div className="flex gap-3 sm:gap-4">
      ...
      <div>
        <h5 className="font-semibold text-foreground text-base sm:text-lg">{title}</h5>
