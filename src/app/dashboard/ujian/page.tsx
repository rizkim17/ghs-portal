                ...
                return (
                  <div key={bab.id} className={`bg-white rounded-2xl shadow-sm border p-5 sm:p-6 transition-all ${
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      {result?.isPassed && <span className="bg-green-50 text-green-700 text-xs font-bold px-2.5 py-0.5 rounded-full border border-green-200">✓ Lulus</span>}
                      {result && !result.isPassed && <span className="bg-red-50 text-red-600 text-xs font-bold px-2.5 py-0.5 rounded-full border border-red-100">✗ Belum Lulus</span>}
                    </div>
                    ...
                    return (
                      <div key={bab.id} className={`bg-white rounded-2xl shadow-sm border p-4 transition-all ${
                        ...
                        <div className="flex items-start justify-between mb-2">
                          ...
                          {result?.isPassed && <span className="bg-green-50 text-green-700 text-[10px] font-bold px-2 py-0.5 rounded-full border border-green-200">✓ Lulus</span>}
                          {result && !result.isPassed && <span className="bg-red-50 text-red-600 text-[10px] font-bold px-2 py-0.5 rounded-full border border-red-100">✗ Gagal</span>}
                        </div>
